export default function HomeHero() {
    ...
    return (
        <>
 <section className="relative min-h-[53rem] w-full bg-[url('../src/assets/housebg.png')] bg-cover bg-center before:absolute before:inset-0 before:bg-black before:opacity-40">
  {/* Content */}
